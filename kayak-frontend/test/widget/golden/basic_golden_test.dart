    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await expectLater(
          find.byType(MaterialApp),
          matchesGoldenFile(
            '../../golden_files/dark/test_app_dark_desktop.png',
          ),
        );
      },
      skip: !Platform.isMacOS,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await expectLater(
          find.byType(MaterialApp),
          matchesGoldenFile(
            '../../golden_files/light/test_app_light_mobile.png',
          ),
        );
      },
      skip: !Platform.isMacOS,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await expectLater(
          find.byType(Card),
          matchesGoldenFile(
            '../../golden_files/light/card_component_light.png',
          ),
        );
      },
      skip: !Platform.isMacOS,
